...
include "mysqlfunc.php";
    $result=write_post($conn,$usrid,$usrname,$_POST['topic'],$_POST['description'],$_POST['tag']);
    if($result==1){
        header("Location:class-forum.php");
    }else{
        echo '<script>alert("发帖失败");</script>';
        header("Location:class-forum-writepost.php");
    }
    }
}
...
<div class="login-window">
    <div class="container container--medium-width">
        <h1 class="newpost" style="color: lightblue;margin-bottom: 30px" >新帖子</h1>
        <form method="post" action="class-forum-writepost.php">
            <h3 style="margin-bottom: 15px;">主题</h3>
            <input type="text" name="topic" placeholder="帖子主题" style="width: 80%"><br>
            <h3 style="margin-bottom: 15px;">描述</h3>
            <div style="width: 80%">
                <textarea rows="5" name="description" placeholder="问题描述" style="width: 100px"></textarea>
            </div>
            <h3 style="margin-bottom: 15px;">设置标签</h3>
            <input type="text" name="tag" placeholder="标签" style="width: 80%"><br>
